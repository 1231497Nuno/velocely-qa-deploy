    ...
    <div className="space-y-6 py-2">
      ...
      <section className="border border-gray-900 rounded-sm bg-gray-900 text-white p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4 text-sm">
          <div><div className="text-gray-400 text-xs">Valor de compra</div><div className="tabular-nums font-medium" data-testid="calc-artigo">{eur(Number(form.custo_artigo) || 0)}</div></div>
