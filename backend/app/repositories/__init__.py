...
categorias_repo = Repository("categorias")
subcategorias_repo = Repository("subcategorias")
...
nao_conformidades_repo = Repository("nao_conformidades")
documentos_financeiros_repo = Repository("documentos_financeiros")
contas_repo = Repository("contas")
...
email_templates_repo = Repository("email_templates")
